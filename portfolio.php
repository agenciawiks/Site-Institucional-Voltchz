            ...
            <div class="portfolio-card fade-item group bg-white/[0.02] border border-white/5 hover:border-brand-green/20 rounded-[24px] overflow-hidden flex flex-col p-4 backdrop-blur-xl shadow-2xl transition-all duration-300 hover:-translate-y-1.5"
                    ...
                    <div class="carousel-images-container w-full h-full flex transition-transform duration-300">
                        <?php foreach ($imgs as $i => $src): ?>
                            <div class="w-full h-full flex-shrink-0 cursor-pointer relative btn-open-lightbox" data-src="<?php echo htmlspecialchars($src); ?>">
                                <img src="<?php echo htmlspecialchars($src); ?>" onerror="this.src='static/logo.webp'; this.classList.add('object-contain', 'p-6')" alt="Instalação <?php echo htmlspecialchars($item['model']); ?> - Foto <?php echo $i+1; ?>" class="w-full h-full object-cover" loading="eager" decoding="async">
                            </div>
                        <?php endforeach; ?>
                    </div>
              ...
              <?php else: ?>
                ...
                <div class="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-brand-bg mb-4 border border-white/5 flex items-center justify-center cursor-pointer btn-open-lightbox" data-src="<?php echo htmlspecialchars($firstImg); ?>">
                    <img src="<?php echo htmlspecialchars($firstImg); ?>" onerror="this.src='static/logo.webp'; this.classList.add('object-contain', 'p-6')" alt="Instalação <?php echo htmlspecialchars($item['model']); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" loading="eager" decoding="async">
