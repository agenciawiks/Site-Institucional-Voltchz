        ...
        <div class="carousel-wrapper relative w-full h-full min-h-[92vh]">
            ...
            <div class="carousel-slide active" id="slide-0">
              ...
              Solicitar Orçamento
                        ...
                        <a href="sobre.html" class="border border-white/20 bg-white/5 backdrop-blur-sm text-brand-text py-4 px-10 rounded-2xl hover:bg-white/10 transition-all font-bold">
              Saiba Mais
            </a>
                    </div>
            ...
            Estações Comerciais
                    ...
                    <a href="contato.html" class="bg-brand-green text-brand-bg font-bold py-4 px-10 rounded-2xl hover:brightness-110 active:scale-95 transition-all shadow-xl shadow-brand-green/20">
            ...
            Orçamento</a>
              ...
              <path
                d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    ...
                    <a href="/viabilidade.html" class="inline-flex items-center gap-2 mt-7 text-[13px] font-bold text-brand-green border border-brand-green/20 px-5 py-2 rounded-xl hover:bg-brand-green/5 transition-colors">Ver
            Mais</a>
                </div>
        ...
        <div class="max-w-[1200px] mx-auto relative z-10">
            ...
            <span class="w-1.5 h-1.5 bg-brand-green rounded-full animate-pulse"></span> Engenharia de Dados Elétricos
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a href="viabilidade.html" class="inline-flex items-center justify-center gap-2.5 bg-brand-green text-brand-bg font-bold py-3.5 px-7 rounded-2xl hover:brightness-110 active:scale-95 transition-all shadow-lg shadow-brand-green/20 text-[14px]">
              Ver Estudo Completo
            ...
            História</span>
              ...
              (ITA/INATEL)</span>, <span class="font-bold text-[#1a1a24]">Mestre (UNIFESP)</span> e <span class="font-bold text-[#1a1a24]">Doutorando pelo ITA</span>. Trazemos o <span class="font-bold text-brand-green">rigor técnico</span> de instituições
                ...
                técnica</span> completa.</p>
                    ...
                    <a href="sobre.html" class="inline-flex items-center gap-2 bg-brand-green text-brand-bg font-bold py-4 px-10 rounded-2xl hover:brightness-110 active:scale-95 transition-all shadow-xl shadow-brand-green/20 mb-10">
            Saiba Mais
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
              <polyline points="9 18 15 12 9 6" />
            </svg>
