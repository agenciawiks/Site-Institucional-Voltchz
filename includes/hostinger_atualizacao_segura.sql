...
REPLACE INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('EW-QP7-ST', 1, 'Sem tomada industrial', 'Projetado para ligação direta via cabo até os bornes internos da estação Wallbox, ideal para acabamento embutido super limpo.');
REPLACE INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('EW-QP7-CT', 1, 'Com tomada industrial', 'Apresenta saída acoplada integrada com tomada industrial azul 32A 2P+T padrão NBR IEC 60309, perfeito para carregadores portáteis potentes.');
...
REPLACE INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (1, 'lei-18403-carregadores-veiculos-eletricos-condominios', 'Lei nº 18.403: o que muda na instalação de carregadores de veículos elétricos em condomínios', 'Legislação', 'Entenda os impactos legais, direitos dos proprietários e as exigências técnicas impostas pela nova lei paulista para a infraestrutura de recarga em garagens prediais.', 'Bruno Riêra', 'Diretor de Engenharia da VoltchZ Brasil', '15 Abr, 2026', '9 min', 'estacoes', 'Lei nº 18.403', 'Legislação');
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'O Marco Legal dos Condomínios e a Mobilidade Elétrica', '', 0);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Principais Mudanças e Direitos Assegurados pela Lei', '', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'list', '', '', 5);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Direito de instalação individual in vagas privativas autônomas ou vinculadas ao apartamento.', 0);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Proibição de barramento injustificado por parte da administração do condomínio sem embasamento técnico.', 1);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Obrigatoriedade de medição individualizada da energia gasta pelo carregador via medidor próprio.', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Necessidade de apresentação prévia de projeto técnico assinado por engenheiro habilitado com ART registrada.', 3);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'O custeio da obra de infraestrutura é integralmente de responsabilidade do condômino solicitante.', 4);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'A administração tem até 60 dias para analisar e responder formalmente ao pedido de instalação.', 5);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Exigências Técnicas Obrigatórias e o Papel do Estudo de Viabilidade', '', 7);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Responsabilidade do Síndico e Penalidades pelo Descumprimento', '', 10);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Como a VoltchZ Atua no Processo de Conformidade Legal', '', 13);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 2, 'heading', 'O que é um Dispositivo DR e por que ele é crucial?', '', 0);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 2, 'heading', 'Classificações dos Dispositivos DR: AC, A e B', '', 3);
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 2, 'paragraph', 'Existem diferentes classes de DR, categorizados conforme o tipo de onda de corrente de fuga que são capazes de identificar e interromper com segurança:', '', 4);
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 2, 'list', '', '', 5);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 2, 'heading', 'O Risco Real da Saturação DC no DR Tipo AC', '', 7);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 2, 'heading', 'Como a VoltchZ Seleciona e Certifica os DRs dos seus Projetos', '', 10);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'heading', 'Entendendo as Curvas de Disparo: B, C e D', '', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'list', '', '', 5);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'heading', 'Capacidade de Ruptura: O Parâmetro que Ninguém Vê na Etiqueta', '', 7);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'heading', 'Fator de Agrupamento e Temperatura Ambiente', '', 10);
...
REPLACE INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (4, 'a-escolha-do-cabo-certo-na-instalacao-de-carregadores-para-veiculos-eletricos', 'A Escolha do Cabo Certo na Instalação de Carregadores para Veículos Elétricos', 'Infraestrutura', 'Calculando a queda de tensão e a seção nominal ideal dos fios condutores para distâncias longas em pátios de estacionamento descobertos.', 'Bruno Riêra', 'Diretor de Engenharia da VoltchZ Brasil', '10 Fev, 2026', '8 min', 'suportes', 'Seção de Cabos', 'Cabo Elétrico');
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'heading', 'Por que o cálculo padrão do eletricista pode comprometer sua instalação?', '', 0);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'heading', 'O Impacto Real da Queda de Tensão no Desempenho do Carregador', '', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'list', '', '', 5);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Abaixo de 15 metros e 32A: Cabo de cobre de 6 mm² in eletroduto exclusivo e ventilado.', 0);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'De 15 a 30 metros e 32A: Cabo de cobre de 10 mm² (reduz drasticamente queda de tensão).', 1);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'De 30 a 50 metros e 32A: Cabo de cobre de 16 mm² (garante quedas abaixo de 3%, conforme NBR 5410).', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Acima de 50 metros e 32A: Cabo de cobre de 25 mm² ou instalação de segundo quadro de distribuição intermediário.', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'heading', 'Método de Instalação: Eletroduto, Calha ou Enterrado', '', 7);
...
REPLACE INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (5, 'seguranca-e-controle-gestao-de-frotas-comerciais', 'Segurança e Controle: Gestão Eficiente de Frotas Comerciais de EVs', 'Tecnologia', 'Como gerenciar e balancear a carga de carregamento de múltiplos veículos elétricos simultâneos de forma inteligente e integrada via OCPP 1.6J.', 'Bruno Riêra', 'Diretor de Engenharia da VoltchZ Brasil', '28 Jan, 2026', '8 min', 'estacoes', 'Gestão de Frotas', 'OCPP Cloud');
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'heading', 'O Desafio da Recarga Simultânea de Frotas Corporativas', '', 0);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'heading', 'Equilíbrio Dinâmico de Carga (Smart Charging) e Protocolo OCPP', '', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'list', '', '', 5);
...
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Programação por Janela Tarifária: Permite configurar o início das recargas para as madrugadas, aproveitando as tarifas de energia mais baixas nos horários fora de pico da concessionária.', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Relatórios de Consumo por Veículo: Controle individualizado do kWh consumido por cada veículo da frota, facilitando o rateio de custos entre departamentos ou projetos específicos.', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'heading', 'Segurança Operacional: Controle de Acesso e Autenticação', '', 7);
...
REPLACE INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (6, 'segundo-a-abve-numeros-indicam-transformacao-mercado-veiculos-eletrificados', 'Segundo a ABVE, o mercado de veículos eletrificados vive uma transformação no Brasil', 'Mercado', 'Análise detalhada do crescimento exponencial das vendas de EVs no mercado nacional e a demanda urgente por engenharia de infraestrutura elétrica qualificada.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '15 Jan, 2026', '7 min', 'estacoes', 'Estatísticas ABVE', 'Dados Mercado');
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'heading', 'Crescimento Histórico e o Boom dos Veículos Elétricos no Brasil', '', 0);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'heading', 'Os Números que Confirmam a Transformação', '', 3);
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'list', '', '', 4);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'O Brasil ultrapassou a marca de 100.000 veículos elétricos em circulação, com taxa de crescimento anual superior a 85% em 2023.', 0);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'São Paulo concentra mais de 40% da frota nacional de EVs, pressionando a infraestrutura de carregamento da maior cidade do hemisfério sul.', 1);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'O mercado de Wallboxes residenciais e comerciais cresceu 220% em volume de instalações em apenas 2 anos.', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'A ABVE estima que o Brasil precisará de mais de 500.000 pontos de recarga instalados até 2030 para atender a demanda prevista.', 3);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Apenas 18% dos novos proprietários de EVs no Brasil têm acesso a um carregador instalado tecnicamente de forma correta.', 4);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'heading', 'O Gargalo Real: Falta de Engenharia Qualificada para Infraestrutura de Recarga', '', 6);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'heading', 'Carregamento como Serviço de Valor Agregado e Nova Receita', '', 3);
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'paragraph', 'Estabelecimentos que já instalaram pontos de recarga EV em seus estacionamentos relatam efeitos positivos concretos e mensuráveis em suas operações comerciais:', '', 4);
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'list', '', '', 5);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Atração e fidelização consistente de um nicho demográfico de alto poder aquisitivo e alta propensão a consumo.', 0);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Aumento médio de 35% a 55% no tempo de permanência de clientes durante a recarga (mais tempo dentro da loja, restaurante ou hotel gerando consumo).', 1);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Cadastro automático do estabelecimento como Eletroposto nos principais aplicativos de rota e navegação para EVs (VoltchZ, ABREVE, Plugshare).', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Possibilidade real de monetizar o serviço de recarga, cobrando um valor por kWh carregado ou por hora de conexão, criando uma nova linha de receita operacional.', 3);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Geração espontânea de marketing positivo associado a ESG, sustentabilidade e inovação tecnológica, sem custo adicional de comunicação.', 4);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Diferenciação competitiva duradoura frente a concorrentes que ainda não investiram in infraestrutura de mobilidade elétrica.', 5);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'heading', 'O ROI Real de um Eletroposto Comercial', '', 7);
...
REPLACE INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (8, 'economia-de-tempo-e-dinheiro-tco-dos-veiculos-eletricos', 'Economia de Tempo e Dinheiro: O TCO Real dos Veículos Elétricos', 'Mercado', 'Calculando a viabilidade financeira e o custo por quilômetro rodado de carros elétricos versus modelos a gasolina nas principais cidades brasileiras.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '18 Dez, 2025', '9 min', 'estacoes', 'TCO e Economia', 'Finanças EV');
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'heading', 'Custo por Quilômetro Rodado: Elétrico versus Gasolina', '', 0);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'heading', 'Total Cost of Ownership (TCO) e Manutenção Quase Nula', '', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'list', '', '', 5);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Eliminação completa de trocas de óleo lubrificante, filtros de óleo, velas de ignição, correias dentadas e de alternador.', 0);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Extinção do sistema de escape, catalisadores e filtros de partículas (itens caros e sujeitos a corrosão e falhas mecânicas).', 1);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Redução de 60% a 80% no desgaste e custo dos freios devido ao sistema de frenagem regenerativa que recupera energia e alivia os discos mecânicos.', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Isenção ou desconto significativo de IPVA em São Paulo (50% de desconto para híbridos e isenção total para elétricos puros em vários estados).', 3);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Redução de gastos com estacionamento e pedágio em cidades como São Paulo e Rio de Janeiro, que oferecem benefícios tarifários para EVs.', 4);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'heading', 'Simulação de Payback para Frotistas Corporativos', '', 7);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'heading', 'Como Dimensionar a Planta Solar para Incluir o Carregamento do EV', '', 3);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'list', '', '', 5);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Levantamento do consumo residencial histórico (12 meses) e adição da demanda estimada do EV.', 0);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Cálculo da irradiação solar local da cidade e do fator de perdas do sistema (cabeamento, inversores, temperatura).', 1);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Dimensionamento da quantidade de painéis e potência do inversor considerando a nova demanda total.', 2);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Integração do Wallbox com o sistema fotovoltaico via comunicação inteligente para priorizar a carga com energia solar.', 3);
REPLACE INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Registro do sistema na concessionária e homologação junto à distribuidora local conforme resolução ANEEL 482.', 4);
...
REPLACE INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'heading', 'V2G e V2H: O Carro como Bateria Estacionária da Casa', '', 7);
