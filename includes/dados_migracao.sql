...
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC1X32H5', 28, 'INCHARGE HOME 5 — 7,4kW Monofásico', '210~240V AC, Cabo 5m, Conector Tipo 2');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC1X32H7', 29, 'INCHARGE HOME 7 — 7,4kW Monofásico', '210~240V AC, Cabo 7m, Conector Tipo 2');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC3X32H5', 30, 'INCHARGE HOME Trifásico 5 — 22kW', '365~415V AC Trifásico, Cabo 5m, Conector Tipo 2');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC3X32H7', 31, 'INCHARGE HOME Trifásico 7 — 22kW', '365~415V AC Trifásico, Cabo 7m, Conector Tipo 2');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC1X32P', 32, 'INCHARGE 7,4kW PLUS', '210~240V AC Monofásico/Bifásico, Cabo 5m, Conector Tipo 2');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC1X32S', 33, 'INCHARGE 7,4kW SMART', '210~240V AC Monofásico/Bifásico, Cabo 5m, NFC + OCPP 1.6J');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC3X32P', 34, 'INCHARGE 22kW PLUS', '365~415V AC Trifásico, Cabo 5m, Conector Tipo 2');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC3X32S', 35, 'INCHARGE 22kW SMART', '365~415V AC Trifásico, Cabo 5m, NFC + OCPP 1.6J');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC1X32S', 36, 'INCHARGE EMVS 30kW', '400 Vca Trifásico, Cabo CCS2 3m, LAN + OCPP 1.6J');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC60kW-DC', 37, 'INCHARGE Fast Charge 60kW', '2× CCS2, Estratégia 60+0 / 0+60 / 30+30 kW, OCPP 1.6J');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('INC150kW-DC', 38, 'INCHARGE Fast Charge 150kW', '2× CCS2, Estratégia 150+0 / 0+150 / 90+60 kW, OCPP 1.6J');
...
INSERT INTO `produto_especificacoes` (`produto_id`, `chave`, `valor`, `ordem`) VALUES (35, 'Humidade relative', '5 / 95%', 479);
