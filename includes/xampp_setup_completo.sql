...
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('EW-QP7-ST', 1, 'Sem tomada industrial', 'Projetado para ligação direta via cabo até os bornes internos da estação Wallbox, ideal para acabamento embutido super limpo.');
INSERT INTO `produto_variacoes` (`sku`, `produto_id`, `nome`, `adicional_desc`) VALUES ('EW-QP7-CT', 1, 'Com tomada industrial', 'Apresenta saída acoplada integrada com tomada industrial azul 32A 2P+T padrão NBR IEC 60309, perfeito para carregadores portáteis potentes.');
...
INSERT INTO `produto_especificacoes` (`produto_id`, `chave`, `valor`, `ordem`) VALUES (1, 'Dimensões Externas', '200mm x 150mm x 120mm', 6);
...
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (1, 'lei-18403-carregadores-veiculos-eletricos-condominios', 'Lei nº 18.403: o que muda na instalação de carregadores de veículos elétricos em condomínios', 'Legislação', 'Entenda os impactos legais, direitos dos proprietários e as exigências técnicas impostas pela nova lei paulista para a infraestrutura de recarga em garagens prediais.', 'Bruno Riêra', 'Diretor de Engenharia da VoltchZ Brasil', '15 Abr, 2026', '9 min', 'estacoes', 'Lei nº 18.403', 'Legislação');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'O Marco Legal dos Condomínios e a Mobilidade Elétrica', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'A recente promulgação da Lei Estadual nº 18.403 no estado de São Paulo trouxe regras muito claras e segurança jurídica para um debate que antes causava grandes desavenças em assembleias de condomínio: a instalação de infraestrutura para carregadores de veículos elétricos em garagens compartilhadas e privativas.', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'Antes da lei, muitos síndicos e comissões de moradores barravam as instalações alegando riscos de incêndio, sobrecarga de transformadores ou falta de acordo na divisão de despesas. Agora, a legislação estipula direitos claros, mas também impõe pesadas exigências técnicas de responsabilidade civil e de engenharia que precisam ser rigorosamente atendidas.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Principais Mudanças e Direitos Assegurados pela Lei', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'O ponto de partida mais importante da Lei nº 18.403 é que o proprietário de vaga privativa demarcada em garagem coletiva tem o direito legítimo de instalar um carregador individual de veículo elétrico. O condomínio não pode proibir a instalação de forma arbitrária, desde que o condômino arque com todos os custos do ramal individual e atenda aos requisitos técnicos exigidos pelo síndico.', '', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'list', '', '', 5);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Direito de instalação individual in vagas privativas autônomas ou vinculadas ao apartamento.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Proibição de barramento injustificado por parte da administração do condomínio sem embasamento técnico.', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Obrigatoriedade de medição individualizada da energia gasta pelo carregador via medidor próprio.', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Necessidade de apresentação prévia de projeto técnico assinado por engenheiro habilitado com ART registrada.', 3);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'O custeio da obra de infraestrutura é integralmente de responsabilidade do condômino solicitante.', 4);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'A administração tem até 60 dias para analisar e responder formalmente ao pedido de instalação.', 5);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'blockquote', 'A segurança da infraestrutura do condomínio é prioritária. O direito à instalação existe, mas está condicionado à comprovação física de viabilidade técnica através de uma Anotação de Responsabilidade Técnica (ART).', 'Bruno Riêra', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Exigências Técnicas Obrigatórias e o Papel do Estudo de Viabilidade', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'Para exercer o direito de instalação, o morador ou a empresa contratada deve fornecer à administração do condomínio um dossiê técnico detalhado. Esse documento deve conter um Estudo de Viabilidade Elétrica completo, comprovando que o ramal individual não causará um desequilíbrio de fases e que o transformador geral suportará a nova demanda permanente.', '', 8);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'Na VoltchZ Brasil, realizamos este estudo in loco utilizando analisadores de curva de carga certificados. Mapeamos a real capacidade do condomínio, analisamos o histórico de consumo de no mínimo 12 meses e fornecemos a documentação exata de engenharia com a respectiva ART, blindando legalmente o síndico e o morador contra quaisquer questionamentos jurídicos ou riscos operacionais.', '', 9);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Responsabilidade do Síndico e Penalidades pelo Descumprimento', '', 10);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'A lei também é clara quanto às obrigações dos síndicos. Negar arbitrariamente, sem embasamento técnico devidamente documentado, o pedido de instalação de carregador por parte de condômino proprietário de vaga demarcada pode configurar abuso de poder administrativo e sujeitar o condomínio a responder judicialmente por danos materiais e morais ao morador.', '', 11);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'Por outro lado, autorizar a instalação sem exigir a documentação técnica obrigatória — especialmente o projeto elétrico assinado e a ART — pode responsabilizar diretamente o síndico em caso de acidentes ou danos à infraestrutura predial comum. O equilíbrio está na conformidade técnica rigorosa, que protege todas as partes envolvidas.', '', 12);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'heading', 'Como a VoltchZ Atua no Processo de Conformidade Legal', '', 13);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 1, 'paragraph', 'Nossa equipe de engenharia atua em todas as etapas do processo de conformidade com a Lei nº 18.403: desde o levantamento técnico inicial da rede elétrica do condomínio, passando pelo dimensionamento do ramal dedicado e seleção dos dispositivos de proteção obrigatórios (DR Classe A ou B, DPS, disjuntor de Curva C), até a emissão da ART e entrega do relatório final para arquivo junto à administração condominial.', '', 14);
...
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'paragraph', 'Em condomínios e edifícios comerciais com transformadores de maior potência, as correntes prospectivas de curto-circuito podem alcançar 10kA ou 15kA nos pontos de distribuição mais próximos do trafo. Instalar um disjuntor com Icu de apenas 3kA nesse cenário representa risco de explosão do dispositivo em caso de falha grave.', '', 9);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'heading', 'Fator de Agrupamento e Temperatura Ambiente', '', 10);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 3, 'paragraph', 'Outro ponto negligenciado é o fator de correção de agrupamento e temperatura. Quando múltiplos disjuntores são instalados lado a lado em um quadro fechado, o calor acumulado de todos eles juntos eleva a temperatura interna do painel. Isso reduz efetivamente a corrente que cada disjuntor consegue conduzir sem disparar por temperatura. Um disjuntor de 32A em um painel com 6 disjuntores agrupados em temperatura ambiente de 35°C precisa ser recalculado para garantir que não haja disparo falso.', '', 11);
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (4, 'a-escolha-do-cabo-certo-na-instalacao-de-carregadores-para-veiculos-eletricos', 'A Escolha do Cabo Certo na Instalação de Carregadores para Veículos Elétricos', 'Infraestrutura', 'Calculando a queda de tensão e a seção nominal ideal dos fios condutores para distâncias longas em pátios de estacionamento descobertos.', 'Bruno Riêra', 'Diretor de Engenharia da VoltchZ Brasil', '10 Fev, 2026', '8 min', 'suportes', 'Seção de Cabos', 'Cabo Elétrico');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'heading', 'Por que o cálculo padrão do eletricista pode comprometer sua instalação?', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'paragraph', 'Um dos erros mais graves e frequentes que encontramos em pátios de condomínio, garagens de casas e instalações comerciais é o subdimensionamento da fiação de cobre alimentadora do carregador. Muitos instaladores sem formação técnica específica utilizam cabos de 4 mm² ou 6 mm² para distâncias de 30 ou 40 metros sob corrente constante de 32A, baseando-se apenas em tabelas genéricas de condução de corrente de curta duração.', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'paragraph', 'Em circuitos longos operando como cargas contínuas prolongadas, um fator crítico entra em cena e invalida completamente esse cálculo simplificado: a queda de tensão ao longo do condutor. A resistência ôhmica do cobre gera perdas que se manifestam como aquecimento do cabo e redução da tensão que efetivamente chega ao carregador.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'heading', 'O Impacto Real da Queda de Tensão no Desempenho do Carregador', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'paragraph', 'Se a tensão cair de 220V para 190V no terminal do EVSE, as consequências são múltiplas e sérias: a potência de carga efetiva cai proporcionalmente ao quadrado da tensão (lei de Joule), aumentando dramaticamente o tempo de recarga completa da bateria. O sistema de comunicação de baixa tensão (piloto CP e PP) do protocolo IEC 61851 pode apresentar erros de comunicação ou simplesmente não reconhecer o carregador como compatível, encerrando a sessão forçosamente.', '', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'list', '', '', 5);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Abaixo de 15 metros e 32A: Cabo de cobre de 6 mm² in eletroduto exclusivo e ventilado.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'De 15 a 30 metros e 32A: Cabo de cobre de 10 mm² (reduz drasticamente queda de tensão).', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'De 30 a 50 metros e 32A: Cabo de cobre de 16 mm² (garante quedas abaixo de 3%, conforme NBR 5410).', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Acima de 50 metros e 32A: Cabo de cobre de 25 mm² ou instalação de segundo quadro de distribuição intermediário.', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'blockquote', 'Bitola de cabo não se escolhe por palpite nem por tabela genérica; ela se calcula combinando a corrente nominal contínua do circuito, a temperatura máxima do ambiente, o método de instalação (eletroduto, cabo livre, enterrado) e a queda de tensão percentual máxima admissível ao longo do percurso.', 'Bruno Riêra', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'heading', 'Método de Instalação: Eletroduto, Calha ou Enterrado', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'paragraph', 'O método de instalação do cabo afeta diretamente sua capacidade de condução de corrente. Cabos em eletroduto fechado têm menor dissipação térmica e menor capacidade de corrente comparados ao mesmo cabo instalado ao ar livre. Cabos enterrados em solo têm capacidade de corrente intermediária, mas exigem proteção mecânica adequada (eletroduto rígido de PVC ou PEAD) e respeito às profundidades mínimas estabelecidas pela NBR 5410.', '', 8);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 4, 'paragraph', 'Na VoltchZ Brasil, todo projeto técnico passa por uma simulação computacional de engenharia para prever com precisão as perdas ôhmicas, o perfil de temperatura do cabo sob carga máxima e a queda de tensão percentual no ponto mais desfavorável do circuito. Isso garante uma operação silenciosa, eficiente e em plena conformidade com as normas brasileiras vigentes.', '', 9);
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (5, 'seguranca-e-controle-gestao-de-frotas-comerciais', 'Segurança e Controle: Gestão Eficiente de Frotas Comerciais de EVs', 'Tecnologia', 'Como gerenciar e balancear a carga de carregamento de múltiplos veículos elétricos simultâneos de forma inteligente e integrada via OCPP 1.6J.', 'Bruno Riêra', 'Diretor de Engenharia da VoltchZ Brasil', '28 Jan, 2026', '8 min', 'estacoes', 'Gestão de Frotas', 'OCPP Cloud');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'heading', 'O Desafio da Recarga Simultânea de Frotas Corporativas', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'paragraph', 'Quando uma empresa decide substituir 10 ou 15 veículos de combustão por modelos elétricos de entrega ou transporte corporativo, a primeira pergunta que surge no departamento de operações é inevitável: como carregar todos esses carros juntos ao final do expediente sem derrubar a energia da sede corporativa e sem pagar multas astronômicas de pico de demanda para a concessionária distribuidora de energia?', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'paragraph', 'Instalar simplesmente 15 carregadores independentes de 22 kW pode resultar em uma demanda instantânea teórica de 330 kW — o suficiente para exigir a contratação emergencial de uma nova cabine primária de alta tensão, com investimentos em transformadores dedicados na casa dos R$ 800 mil a R$ 1,2 milhão. A solução tecnicamente correta e economicamente viável passa obrigatoriamente por segurança ativa e controle inteligente de carga via software.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'heading', 'Equilíbrio Dinâmico de Carga (Smart Charging) e Protocolo OCPP', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'paragraph', 'Através do protocolo de comunicação universal OCPP 1.6J (Open Charge Point Protocol), as estações de carregamento da linha E-Wolf da VoltchZ se comunicam em tempo real com plataformas de gestão na nuvem, permitindo que o gestor da frota controle de forma centralizada todas as recargas simultâneas:', '', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'list', '', '', 5);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Balanceamento Dinâmico de Carga (Smart Load Management): Distribui a potência disponível na fábrica ou sede corporativa entre os veículos conectados de forma equitativa e automática. Se há apenas 1 carro, ele recebe a potência máxima (22 kW). Se conectam 10 carros, o sistema distribui a potência de acordo com o limite de demanda seguro pré-configurado pelo gestor.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Priorização Inteligente por Rota: O administrador da frota pode indicar no painel de controle web quais veículos precisam sair mais cedo no dia seguinte, e o sistema direciona automaticamente maior potência de carga para esses veículos de forma prioritária.', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Programação por Janela Tarifária: Permite configurar o início das recargas para as madrugadas, aproveitando as tarifas de energia mais baixas nos horários fora de pico da concessionária.', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Relatórios de Consumo por Veículo: Controle individualizado do kWh consumido por cada veículo da frota, facilitando o rateio de custos entre departamentos ou projetos específicos.', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'blockquote', 'A chave para eletrificar frotas corporativas com eficiência real não está em contratar mais energia da concessionária. Está em gerenciar a energia disponível com inteligência ativa, automação e controle de dados em tempo real.', 'Bruno Riêra', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'heading', 'Segurança Operacional: Controle de Acesso e Autenticação', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'paragraph', 'Para frotas corporativas privadas, a segurança operacional é tão importante quanto a eficiência energética. As estações E-Wolf suportam autenticação por RFID (cartão de aproximação único por motorista), QR Code via aplicativo VoltchZ Mobile e PIN individualizado. Isso significa que apenas motoristas autorizados conseguem iniciar sessões de carregamento, eliminando o uso indevido da infraestrutura corporativa por terceiros.', '', 8);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 5, 'paragraph', 'Todos os dados de autenticação, tempo de sessão, energia consumida e custo calculado são registrados na nuvem em tempo real, com exportação de relatórios em CSV ou PDF para integração com sistemas de gestão de frotas (TMS) e softwares de contabilidade corporativa.', '', 9);
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (6, 'segundo-a-abve-numeros-indicam-transformacao-mercado-veiculos-eletrificados', 'Segundo a ABVE, o mercado de veículos eletrificados vive uma transformação no Brasil', 'Mercado', 'Análise detalhada do crescimento exponencial das vendas de EVs no mercado nacional e a demanda urgente por engenharia de infraestrutura elétrica qualificada.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '15 Jan, 2026', '7 min', 'estacoes', 'Estatísticas ABVE', 'Dados Mercado');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'heading', 'Crescimento Histórico e o Boom dos Veículos Elétricos no Brasil', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'paragraph', 'Os relatórios e dados divulgados pela Associação Brasileira do Veículo Elétrico (ABVE) confirmam com números concretos o que já se nota visivelmente nas ruas das principais capitais e rodovias do país: o mercado brasileiro está atravessando uma transição energética acelerada, estrutural e sem volta rumo à mobilidade sustentável de baixo carbono.', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'paragraph', 'O crescimento das vendas de carros totalmente elétricos (BEV) e híbridos plug-in (PHEV) rompeu todas as projeções conservadoras que analistas do setor faziam apenas 4 anos atrás. Essa nova realidade mercadológica coloca em evidência um gargalo técnico dramático e urgente: a velocidade de aquisição de novos veículos pelos motoristas e frotistas está muito à frente da velocidade de instalação de carregadores confiáveis, homologados e seguros nas garagens de condomínios, rodovias e pontos comerciais de todo o país.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'heading', 'Os Números que Confirmam a Transformação', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'list', '', '', 4);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'O Brasil ultrapassou a marca de 100.000 veículos elétricos em circulação, com taxa de crescimento anual superior a 85% em 2023.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'São Paulo concentra mais de 40% da frota nacional de EVs, pressionando a infraestrutura de carregamento da maior cidade do hemisfério sul.', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'O mercado de Wallboxes residenciais e comerciais cresceu 220% em volume de instalações em apenas 2 anos.', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'A ABVE estima que o Brasil precisará de mais de 500.000 pontos de recarga instalados até 2030 para atender a demanda prevista.', 3);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Apenas 18% dos novos proprietários de EVs no Brasil têm acesso a um carregador instalado tecnicamente de forma correta.', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'blockquote', 'A mobilidade elétrica no Brasil já é realidade comercial consolidada e irreversível. Agora, o grande desafio nacional migrou do pátio das concessionárias de veículos para as garagens, os condomínios e as rodovias — onde a engenharia elétrica de qualidade é absolutamente indispensável.', 'Bruno Riêra', 5);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'heading', 'O Gargalo Real: Falta de Engenharia Qualificada para Infraestrutura de Recarga', '', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'paragraph', 'Para cada 10 carros elétricos novos que entram em circulação no mercado nacional, é necessário ao menos 1 ponto de carregamento rápido público e cerca de 9 carregadores residenciais e condominiais fixos instalados nas vagas de garagens. Se as redes elétricas prediais existentes não forem adequadas com sistemas modernos de segurança ativa, proteção DR Classe A ou B e estudos de viabilidade criteriosos, o país poderá vivenciar apagões pontuais e queima de transformadores prediais.', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 6, 'paragraph', 'A VoltchZ Brasil nasceu exatamente para preencher esse vácuo de engenharia qualificada e responsabilidade técnica no setor. Nossa missão é que cada veículo elétrico que chegar ao Brasil tenha um ponto de carregamento seguro, eficiente e legal esperando por ele em casa, no trabalho ou na estrada.', '', 8);
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (7, 'conconveniencia-carregamento-residencial-comercial', 'Conveniência: O Impacto Positivo dos Carregadores na Atração de Clientes', 'Mercado', 'Entenda como hotéis, shoppings e comércios estão fidelizando clientes de alto poder aquisitivo simplesmente disponibilizando pontos de recarga em suas vagas.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '03 Jan, 2026', '6 min', 'suportes', 'Eletropostos Comerciais', 'Fidelização');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'heading', 'O Novo Critério de Decisão do Consumidor de EV', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'paragraph', 'Imagine que o proprietário de um veículo elétrico premium está planejando uma viagem de final de semana com a família para o litoral ou a serra. Ao pesquisar pousadas, hotéis ou resorts no destino escolhido, qual será o seu primeiro critério de exclusão ao comparar as opções disponíveis?', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'paragraph', 'A resposta é simples e direta: se o estabelecimento não dispõe de carregador para veículos elétricos em sua garagem privativa, o cliente simplesmente o elimina da lista de consideração sem pensar duas vezes, optando pelo concorrente que oferece essa comodidade essencial. Este é o poder disruptivo e crescente do carregamento como fator de conveniência ativa na decisão de compra e fidelização de clientes qualificados.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'heading', 'Carregamento como Serviço de Valor Agregado e Nova Receita', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'paragraph', 'Estabelecimentos que já instalaram pontos de recarga EV em seus estacionamentos relatam efeitos positivos concretos e mensuráveis em suas operações comerciais:', '', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'list', '', '', 5);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Atração e fidelização consistente de um nicho demográfico de alto poder aquisitivo e alta propensão a consumo.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Aumento médio de 35% a 55% no tempo de permanência de clientes durante a recarga (mais tempo dentro da loja, restaurante ou hotel gerando consumo).', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Cadastro automático do estabelecimento como Eletroposto nos principais aplicativos de rota e navegação para EVs (VoltchZ, ABREVE, Plugshare).', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Possibilidade real de monetizar o serviço de recarga, cobrando um valor por kWh carregado ou por hora de conexão, criando uma nova linha de receita operacional.', 3);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Geração espontânea de marketing positivo associado a ESG, sustentabilidade e inovação tecnológica, sem custo adicional de comunicação.', 4);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Diferenciação competitiva duradoura frente a concorrentes que ainda não investiram in infraestrutura de mobilidade elétrica.', 5);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'blockquote', 'A recarga de carros elétricos em estabelecimentos comerciais deixou definitivamente de ser um diferencial de inovação para se consolidar como infraestrutura básica obrigatória de atração e retenção de clientes de alto valor.', 'Bruno Riêra', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'heading', 'O ROI Real de um Eletroposto Comercial', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 7, 'paragraph', 'Com base em projetos instalados pela VoltchZ Brasil em hotéis, restaurantes e redes de varejo, um eletroposto comercial de 22 kW bem posicionado, com cobrança por kWh, apresenta retorno sobre o investimento em um prazo médio de 18 a 30 meses, dependendo do fluxo de veículos elétricos na região e do modelo de monetização escolhido pelo estabelecimento.', '', 8);
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (8, 'economia-de-tempo-e-dinheiro-tco-dos-veiculos-eletricos', 'Economia de Tempo e Dinheiro: O TCO Real dos Veículos Elétricos', 'Mercado', 'Calculando a viabilidade financeira e o custo por quilômetro rodado de carros elétricos versus modelos a gasolina nas principais cidades brasileiras.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '18 Dez, 2025', '9 min', 'estacoes', 'TCO e Economia', 'Finanças EV');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'heading', 'Custo por Quilômetro Rodado: Elétrico versus Gasolina', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'paragraph', 'Apesar de apresentarem um valor de aquisição inicial mais elevado nas concessionárias, os carros elétricos trazem benefícios financeiros expressivos e mensuráveis na planilha de custos operacionais ao longo da vida útil do veículo. O principal e mais imediato pilar de economia é o custo do combustível por quilômetro rodado.', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'paragraph', 'Enquanto percorrer 100 km com um veículo popular a combustão abastecido com gasolina comum consome entre R$ 55,00 e R$ 72,00 nas capitais brasileiras (com gasolina a R$ 6,00/litro e consumo de 10 a 12 km/l), percorrer a mesma distância com um veículo elétrico de eficiência equivalente custa entre R$ 10,00 e R$ 18,00 na tarifa residencial de energia elétrica, representando uma redução de custo de 70% a 85% no item combustível.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'heading', 'Total Cost of Ownership (TCO) e Manutenção Quase Nula', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'paragraph', 'Além da economia imediata em combustível, o TCO (Custo Total de Propriedade) de um veículo elétrico ao longo de 5 anos é significativamente inferior ao de um equivalente a combustão. O principal componente dessa vantagem é a drástica redução de custos de manutenção preventiva e corretiva.', '', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'list', '', '', 5);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Eliminação completa de trocas de óleo lubrificante, filtros de óleo, velas de ignição, correias dentadas e de alternador.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Extinção do sistema de escape, catalisadores e filtros de partículas (itens caros e sujeitos a corrosão e falhas mecânicas).', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Redução de 60% a 80% no desgaste e custo dos freios devido ao sistema de frenagem regenerativa que recupera energia e alivia os discos mecânicos.', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Isenção ou desconto significativo de IPVA em São Paulo (50% de desconto para híbridos e isenção total para elétricos puros em vários estados).', 3);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Redução de gastos com estacionamento e pedágio em cidades como São Paulo e Rio de Janeiro, que oferecem benefícios tarifários para EVs.', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'blockquote', 'Quando se considera o TCO real ao longo de 60 meses de propriedade, incluindo combustível, manutenção, seguros e benefícios fiscais, o veículo elétrico apresenta vantagem financeira total sobre o equivalente a combustão a partir do 2º ou 3º ano de uso — muito antes do que a maioria das pessoas imagina.', 'Bruno Riêra', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'heading', 'Simulação de Payback para Frotistas Corporativos', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'paragraph', 'Para empresas com frotas de 5 ou mais veículos, a vantagem do EV é ainda mais dramática. Uma empresa que substitui 10 utilitários de combustão por modelos elétricos equivalentes pode economizar entre R$ 180.000 e R$ 280.000 anuais apenas em combustível e manutenção, sem contar os benefícios de imagem ESG e as isenções de impostos estaduais.', '', 8);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 8, 'paragraph', 'A infraestrutura de carregamento corporativo para 10 veículos, instalada com qualidade pela VoltchZ Brasil incluindo o sistema Smart Charging via OCPP, custa entre R$ 85.000 e R$ 140.000 dependendo da localização e potência selecionada — representando payback total da infraestrutura em menos de 8 meses de operação.', '', 9);
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (9, 'independencia-energetica-energia-solar-e-carregadores-evs', 'Independência Energética: O Casamento Perfeito da Energia Solar com o EV', 'Tecnologia', 'Como gerar seu próprio combustível solar em casa de forma totalmente autônoma, sustentável e livre das oscilações da conta de energia.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '02 Dez, 2025', '9 min', 'protecao', 'Solar + EV', 'Sustentabilidade');
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'heading', 'Gerando Combustível Solar Gratuito no Telhado de Casa', '', 0);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'paragraph', 'A maior e mais revolucionária promessa de liberdade do veículo elétrico reside na possibilidade concreta de eliminar completamente a dependência de postos de combustível, de refinarias e dos preços voláteis do petróleo. Ao integrar uma planta de microgeração fotovoltaica no telhado de sua residência ou empresa, o usuário de EV passa a produzir eletricidade limpa com custo marginal praticamente zero, utilizando a radiação solar abundante que o Brasil recebe.', '', 1);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'paragraph', 'Essa energia solar produzida durante as horas de sol é injetada na rede da concessionária e gera créditos de energia elétrica (sistema de compensação da ANEEL), que por sua vez abastecem o carregador do carro à noite. O resultado prático é que o "combustível" do veículo elétrico passa a custar próximo de zero, com investimento inicial que se paga em 4 a 6 anos e vida útil dos painéis superior a 25 anos.', '', 2);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'heading', 'Como Dimensionar a Planta Solar para Incluir o Carregamento do EV', '', 3);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'paragraph', 'O grande erro que muitos proprietários cometem é instalar uma planta fotovoltaica dimensionada apenas para o consumo histórico da residência, sem contemplar a nova demanda gerada pelo carregamento do veículo elétrico. Um carro elétrico com autonomia de 400 km e consumo típico de 15 kWh/100 km percorrendo 1.500 km por mês adicionará cerca de 225 kWh/mês à conta de energia.', '', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'list', '', '', 5);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Levantamento do consumo residencial histórico (12 meses) e adição da demanda estimada do EV.', 0);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Cálculo da irradiação solar local da cidade e do fator de perdas do sistema (cabeamento, inversores, temperatura).', 1);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Dimensionamento da quantidade de painéis e potência do inversor considerando a nova demanda total.', 2);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Integração do Wallbox com o sistema fotovoltaico via comunicação inteligente para priorizar a carga com energia solar.', 3);
INSERT INTO `artigo_conteudo_list_items` (`artigo_conteudo_id`, `item`, `ordem`) VALUES (LAST_INSERT_ID(), 'Registro do sistema na concessionária e homologação junto à distribuidora local conforme resolução ANEEL 482.', 4);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'blockquote', 'A combinação de geração solar + armazenamento em bateria estacionária + veículo elétrico transforma o consumidor passivo de energia em um prosumidor ativo, produzindo, consumindo e gerenciando sua própria energia com total autonomia e inteligência.', 'Bruno Riêra', 6);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'heading', 'V2G e V2H: O Carro como Bateria Estacionária da Casa', '', 7);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'paragraph', 'O próximo passo evolutivo da integração solar + EV é o ecossistema inteligente bidirecional, no qual o veículo elétrico não apenas consome energia do telhado solar, mas também retorna energia da sua bateria de alta capacidade para alimentar a residência (V2H — Vehicle to Home) nos momentos de blecaute ou de tarifas elevadas pela concessionária.', '', 8);
INSERT INTO `artigo_conteudo` (`id`, `artigo_id`, `tipo`, `texto`, `autor_citado`, `ordem`) VALUES (NULL, 9, 'paragraph', 'No nível mais avançado, o conceito V2G (Vehicle to Grid) permite que o proprietário venda de volta à rede pública o excedente de energia armazenado na bateria do veículo nos momentos de pico de demanda do sistema elétrico nacional, gerando uma fonte de renda passiva enquanto o carro está estacionado. Esta tecnologia já é realidade em alguns países europeus e está rapidamente avançando no mercado brasileiro.', '', 9);
