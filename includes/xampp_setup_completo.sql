...
INSERT INTO `artigos` (`id`, `slug`, `titulo`, `categoria`, `resumo`, `autor`, `cargo`, `data_publicacao`, `tempo_leitura`, `svg_metadata_category`, `svg_metadata_title`, `svg_metadata_subtitle`) VALUES (8, 'economia-de-tempo-e-dinheiro', 'Economia de Tempo e Dinheiro | VoltchZ Brasil', 'Mercado', 'Calculando a viabilidade financeira e o custo por quilômetro rodado de carros elétricos versus modelos a gasolina nas principais cidades brasileiras.', NULL, 'Diretor de Engenharia da VoltchZ Brasil', '18 Dez, 2025', '9 min', 'estacoes', 'TCO e Economia', 'Finanças EV');
