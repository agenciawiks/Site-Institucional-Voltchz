    <!-- ──────────────────────────────────────────
        ...
        <span class="absolute right-full mr-4 bg-white text-black text-[12px] font-bold px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-xl pointer-events-none">
            Conversar agora
        </span>
    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3 text-brand-muted text-sm pt-3 border-t border-white/5">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="mt-0.5">
                ...
                <!-- Hours -->
                <div class="flex flex-col gap-6">
                    <h4 class="text-white font-bold text-sm uppercase tracking-widest">Horário</h4>
                    <div class="space-y-4 text-sm text-brand-muted">
                        <div class="flex flex-col gap-1">
                            <span class="text-white font-semibold">Atendimento online: Segunda - Sexta</span>
                            <span>09:00 - 17:00</span>
                        </div>
                        <div class="flex flex-col gap-1">
                            <span class="text-white font-semibold">Sábado, Domingo e Feriados</span>
                            <span>Fechado</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- CTA de Contato -->
                <div class="flex flex-col gap-6">
                    <h4 class="text-white font-bold text-sm uppercase tracking-widest">Fale com a VoltchZ</h4>
                    ...
                    <p class="text-brand-muted text-xs leading-relaxed">
                        Atendimento online com equipe técnica especializada em mobilidade elétrica.
                    </p>
                </div>
            </div>
    ...
    <div id="success-modal" class="fixed inset-0 z-[150] bg-black/80 backdrop-blur-md hidden items-center justify-center p-6 transition-all duration-300">
        <div class="bg-brand-bg2 border border-white/10 rounded-[32px] p-8 max-w-[480px] w-full text-center relative shadow-2xl">
            <div class="w-16 h-16 bg-brand-green/10 rounded-full flex items-center justify-center mx-auto mb-6 text-brand-green">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                    <polyline points="20 6 9 17 4 12"></polyline>
                </svg>
            </div>
            <h3 class="text-2xl font-bold mb-3">Mensagem Enviada!</h3>
            <p class="text-brand-muted text-sm leading-relaxed mb-8">
                Agradecemos o contato. Nossa equipe técnica retornará sua mensagem o mais breve possível.
            </p>
            <button class="close-modal bg-brand-green text-brand-bg font-bold py-3 px-8 rounded-xl hover:brightness-110 transition-all w-full">
                Entendido
            </button>
        </div>
    </div>
