        ...
        <div class="lg:col-span-7 flex flex-col">
          ...
          <div class="mb-8">
            <a id="budget-whatsapp-btn" href="<?php echo get_budget_url($produto, $has_variations ? $produto['variacoes'][0] : null); ?>" target="_blank" rel="noopener noreferrer"
              class="w-full inline-flex items-center justify-center gap-3 bg-brand-green text-brand-bg text-lg font-bold uppercase tracking-wider px-12 py-6 rounded-2xl hover:brightness-110 active:scale-95 transition-all shadow-xl shadow-brand-green/20 text-center">
