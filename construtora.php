...
$page_title = "Projetos de Recarga para Construtoras — VoltchZ Brasil";
$page_desc = "Engenharia de recarga veicular para construtoras e incorporadoras. Planejamento técnico na fase de obras em conformidade técnica e valorização imobiliária.";
$current_page = "construtora";
  ...
  <header class="relative pt-32 pb-20 overflow-hidden bg-brand-bg2">
    ...
    <div class="max-w-[1200px] mx-auto px-6 relative z-10 text-center">
      ...
      <p class="text-lg text-brand-muted max-w-3xl mx-auto leading-relaxed">
        Soluções integradas de infraestrutura de carregamento veicular projetadas e instaladas durante a fase de obras. Garanta economia construtiva, conformidade técnica e agregue valor comercial ao seu empreendimento.
      </p>
    </div>
  </header>
    ...
    <div class="max-w-[1200px] mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white/[0.02] border border-white/5 p-8 rounded-3xl hover:border-brand-green/20 transition-all duration-300">
          ...
          <h3 class="text-lg font-bold text-white mb-3">Redução Drástica de Custo</h3>
          <p class="text-sm text-brand-muted leading-relaxed">
            Planejar e implantar barramentos blindados, caixas de passagem e tubulação seca durante a fundação e alvenaria chega a custar até 80% menos do que adequar a garagem após a entrega da obra.
          </p>
        </div>
        ...
        <div class="bg-white/[0.02] border border-white/5 p-8 rounded-3xl hover:border-brand-green/20 transition-all duration-300">
          ...
          <h3 class="text-lg font-bold text-white mb-3">Consultoria e Projetos</h3>
          <p class="text-sm text-brand-muted leading-relaxed">
            Elaboramos o projeto de engenharia elétrica completo da infraestrutura de recarga para aprovação junto à concessionária de energia, incluindo laudos de demanda energética e estudos de seletividade.
          </p>
        </div>
        ...
        <div class="bg-white/[0.02] border border-white/5 p-8 rounded-3xl hover:border-brand-green/20 transition-all duration-300">
          <div class="w-12 h-12 rounded-2xl bg-brand-green/10 flex items-center justify-center mb-6">
            <svg class="w-6 h-6 text-brand-green" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
          </div>
          <h3 class="text-lg font-bold text-white mb-3">Selo de Eletromobilidade</h3>
          <p class="text-sm text-brand-muted leading-relaxed">
            Agregue o apelo sustentável e inovador da VoltchZ Brasil ao seu material comercial de lançamento. Edifícios preparados para recarga veicular possuem maior velocidade de vendas e valorização no mercado.
          </p>
        </div>
  ...
  <section class="py-16 px-6 bg-brand-bg relative z-10 border-t border-white/5">
    <div class="max-w-[1200px] mx-auto">
      <div class="text-center max-w-2xl mx-auto mb-16">
        ...
        <h2 class="text-3xl font-extrabold text-white">Nosso Portfólio em Incorporadoras</h2>
        <p class="text-sm text-brand-muted mt-3">Projetos em fase de execução de obra e adequações estruturais homologadas.</p>
      </div>

      <!-- Grid de Projetos -->
      <div id="construtoras-grid-page" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Injetado via JS -->
      </div>
    </div>
  </section>
  ...
  <section class="relative bg-brand-bg3 py-20 px-6 border-t border-white/5 overflow-hidden z-10">
    <div class="max-w-[800px] mx-auto text-center relative z-10">
      <h2 class="text-3xl font-extrabold tracking-tight mb-6">
        Precisa de assessoria de engenharia na sua obra?
      </h2>
      <p class="text-brand-muted text-base leading-relaxed mb-8 font-normal">
        Nossos engenheiros especialistas analisam o seu projeto de instalações para otimizar os caminhos elétricos de recarga de forma eficiente e em total conformidade técnica com as normas.
      </p>
      <a href="<?php echo htmlspecialchars(get_config('whatsapp_link', 'https://wa.me/5512981039845?text=Ola!%20Trabalho%20em%20uma%20construtora%20e%20gostaria%20de%20conversar%20sobre%20projetos%20de%20recarga%20veicular.')); ?>" target="_blank" rel="noopener noreferrer"
        ...
        Falar com Engenheiro Projetista
      </a>
    </div>
  </section>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const grid = document.getElementById("construtoras-grid-page");
        if (!grid) return;
        ...
        const filtered = portfolioData.filter(item => {
            return item.tipo === 'construtora' && item.image;
        });

        if (filtered.length === 0) {
            grid.innerHTML = `
                <div class="col-span-full text-center py-16 bg-white/[0.02] border border-white/5 border-dashed rounded-3xl">
                    <p class="text-brand-muted text-sm italic">Nenhum projeto de construtora cadastrado no momento.</p>
                </div>
            `;
            return;
        }
            ...
            card.innerHTML = `
                ...
                <div class="flex-grow flex flex-col">
                    <div class="flex items-center justify-between gap-4 mb-2">
                        <span class="text-[9px] font-mono font-black uppercase tracking-[0.2em] text-brand-green">CONSTRUTORA</span>
